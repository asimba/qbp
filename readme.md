...
| :arrow_right: | $\textbf{lz16}$ <br/> `(built with "gcc -O3")` | $\textbf{c}$ | $\textbf{407180647}$ | $\textbf{31,50}$ | $\textbf{3,34}$ |  
...
| | snappy (1.1.1.8) snzip/snunzip <br/> [(by Robert Važan)](https://snappy.machinezoo.com/) <br/>[(algorithm by Google)](https://google.github.io/snappy/) | | 507879264 | 3,97 | 2,25 |  
